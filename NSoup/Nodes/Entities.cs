...
namespace NSoup.Nodes
{
    ...
    public class Entities
    {
        ...
        public static string Unescape(string s, bool strict)
        {
            ...
            return unescape.Replace(s, new MatchEvaluator(delegate(Match m)
            {
                ...
                if (!string.IsNullOrEmpty(num))
                {
                    try
                    {
                        int numbase = !string.IsNullOrEmpty(m.Groups[2].Value) ? 16 : 10; // 2 is hex indicator
                        charval = Convert.ToInt32(num, numbase);
                    }
                ...
                { // out of range
                    string c = char.ToString((char)charval);
                    return c;
                }
        ...
        // e.g. &amp
        private static readonly object[,] baseArray = new object[,] {
            {"AElig", 0x000C6},
            {"AMP", 0x00026},
            {"Aacute", 0x000C1},
            {"Acirc", 0x000C2},
        ...
        private static readonly object[,] fullArray = new object[,] {
            {"AElig", 0x000C6},
            {"AMP", 0x00026},
            {"Aacute", 0x000C1},
            {"Abreve", 0x00102},
